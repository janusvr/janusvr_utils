	...
	function loadsettings()
	{
		...
		if (settings == null)
		{
			...
			settings.push({ name:"Business Suit Man", string: escape("<FireBoxRoom><Assets><AssetObject id=\"ghost_business_obj\" mtl=\"http://legacy.spyduck.net/avatar/mtl/BusinessGuy.mtl\" src=\"http://legacy.spyduck.net/avatar/obj.gz/CardboardGuy.obj.gz\" /></Assets><Room><Ghost id=\"Business_Suit_Man\" col=\"randomColor()\" scale=\"1 1 1\" lighting=\"false\" head_pos=\"0 1.2 0\" body_id=\"ghost_business_obj\" cull_face=\"none\" /></Room></FireBoxRoom>")});
			settings.push({ name:"Woman in a Dress", string: escape("<FireBoxRoom><Assets><AssetObject id=\"ghost_reddress_obj\" mtl=\"http://legacy.spyduck.net/avatar/mtl/DressLady.mtl\" src=\"http://legacy.spyduck.net/avatar/obj.gz/CardboardGuy.obj.gz\" /></Assets><Room><Ghost id=\"Business_Suit_Man\" col=\"randomColor()\" scale=\"1 1 1\" lighting=\"false\" head_pos=\"0 1.2 0\" body_id=\"ghost_reddress_obj\" cull_face=\"none\" /></Room></FireBoxRoom>")});
	...
	{
		var blank_avatar = "<FireBoxRoom><Assets></Assets><Room><Ghost id=^Name^ interp_time=^0.1^ pos=^0 0 0^ vel=^0 0 0^ accel=^0 0 0^ xdir=^0 0 1^ ydir=^0 1 0^ zdir=^-1 0 0^ scale=^1 1 1^ col=^#ffffff^ lighting=^true^ visible=^true^ shader_id=^^ head_id=^^ head_pos=^0 1 0^ body_id=^^ anim_id=^type^ anim_speed=^1^ eye_pos=^0 1.6 0^ eye_ipd=^0^ userid_pos=^0 0.5 0^ loop=^false^ gain=^1^ pitch=^1^ auto_play=^false^ cull_face=^back^ play_once=^false^ /></Room></FireBoxRoom>";
		...
		janus.setavatar(blank_avatar.replace( /Ghost id="(.*?)"/i, "Ghost id=\""+parent.window.janus.userid+"\""));
